...
func UploadBannerEndPoint(w http.ResponseWriter, r *http.Request) {

	imgFile, handler, _ := r.FormFile("banner")

	var extension = strings.Split(handler.Filename, ".")[1]

	var file string = "public/uploads/banner/" + GlobalID + "." + extension
	...
	user.Banner = GlobalID + "." + extension
